...
$(document).ready(function() {
    $('ul.hello').quote_rotator({
              rotation_speed: 4000,                    // defaults to 5000
              pause_on_hover: false,                   // defaults to true
              randomize_first_quote: false              // defaults to false
                });
                $('ul.button_quotes').quote_rotator({
                    buttons: { next: '<img src="images/right.png">', previous: '<img src="images/left.png">' }
                });
